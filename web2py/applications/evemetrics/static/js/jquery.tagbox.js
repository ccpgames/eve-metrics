 ...
 *   http://www.gnu.org/licenses/gpl.html
  ...
  WARNING: Has additions from Nonni
...
(function(jQuery) {
  jQuery.fn.tagBox = function(options) {
    var defaults = {
      ...
      afterTagRemove: function(removed_tag) {} // Addition from Nonni
    }
      ...
      function generate_tags_list(tags_list) {
        ...
        jQuery.each(tags_list, function(key, val) {
          if(val != "") {
            ...
            $tag_list_elem.append('<span class="'+options.className+'-item"><span class="'+options.className+'-bullet">&bull;</span><span class="'+options.className+'-item-content">'+remove_tag_link+'<a href="Tags?tag='+display_val+'">'+display_val+'</a></span></span>');
          }
        });
